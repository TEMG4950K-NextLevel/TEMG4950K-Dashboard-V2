...
export default function LaunchModal({ launchIsOpen, onClose }) {
  ...
  return (
    // main modal
    <>
      <Modal show={launchIsOpen} size="2xl" popup={true} onClose={onClose}>
        <Modal.Header />
        <Modal.Body>
          ...
          <div className="flex flex-col space-y-4 place-content-center px-6">
            ...
            <div className="flex flex-row space-x-3 ml-7 items-center">
              ...
              <Select id="billing-account" required={true}>
                <option>Adidas-Account-1</option>
                <option>Adidas-Account-2</option>
              </Select>
            </div>

            <Label className="text-xl" value="Campaign Settings" />
            <div className="flex flex-row space-x-3 ml-7 items-center">
              <Label className="text-lg w-24" value="Start Date" />
              <Datepicker
